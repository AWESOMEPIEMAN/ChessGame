...
void Board::printBoard() {
	using namespace std;
	cout << endl;
	cout << "To play, you will have to input the chess piece position as xy coordinates \nand then again a xy position for the move. Like 0102 to move pawn to new position :D" << endl;
	cout << endl;
...
bool Board::doMove() {
	...
	{
		cout << endl;
		(turn == WHITE) ? cout << "LEFT SIDE's TURN " << endl : cout << "RIGHT SIDE's TURN" << endl;
		cout << "Move : ";
		cin >> move;
		x1 = move[0] - 48;
		y1 = move[1] - 48;
